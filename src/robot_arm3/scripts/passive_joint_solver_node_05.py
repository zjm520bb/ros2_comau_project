...
class PassiveJointSolver05(Node):
    """Passive joint solver for the renamed joint_7 / joint_8 passive pair."""

    def __init__(self) -> None:
        super().__init__("passive_joint_solver_05")
        ...
        self.get_logger().info(
            "Passive joint solver 05 started. Reading /joint_states_raw and publishing /joint_states."
        )
    ...
    def solve_passive_joints(
        ...
        joint_7 = joint_2 + joint_3 + 1.5708 + joint_7_offset
        joint_8 = -(joint_2 + joint_3 + 1.5708) + joint_8_offset
