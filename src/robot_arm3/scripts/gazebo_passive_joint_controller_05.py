...
class GazeboPassiveJointController05(Node):
    """Command renamed Gazebo passive joints from the renamed active joint states."""

    def __init__(self) -> None:
        super().__init__("gazebo_passive_joint_controller_05")
        ...
        self.get_logger().info(
            "Gazebo passive joint controller 05 started. "
...
def main() -> None:
    rclpy.init()
    node = GazeboPassiveJointController05()
