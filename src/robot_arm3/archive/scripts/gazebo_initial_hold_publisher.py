...
class GazeboInitialHoldPublisher(Node):
    """Publish the initial zero-position hold command for the active joints."""
    ...
    def __init__(self) -> None:
        super().__init__("gazebo_initial_hold_publisher")
...
def main() -> None:
    rclpy.init()
    node = GazeboInitialHoldPublisher()
