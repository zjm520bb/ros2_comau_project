...
def generate_launch_description():
    ...
    xacro_file = os.path.join(package_share_dir, "urdf", "robot_arm3_control_02.urdf.xacro")
    ...
    spawn_robot = Node(
        package="ros_gz_sim",
        executable="create",
        name="spawn_robot_arm3_control_02",
        output="screen",
        arguments=[
            "-world",
            "empty",
    ...
    gazebo_passive_joint_controller = Node(
        package="robot_arm3",
        executable="gazebo_passive_joint_controller.py",
        name="gazebo_passive_joint_controller",
        output="screen",
    )
